...
class TestDGA:
    def __init__(self, root):
        ...
        frame_fileinfo = Label(self.root, width=85, height=5, bg="white")
        btnFrame = Frame(self.root, bd=2, relief=RIDGE, bg="white")
        ...
        btnTest = Button(btnFrame, text="Test", command=self.run_test, width=17, font=("times new roman", 13, "bold"),
                         bg="blue", fg="white")
        btn_list = Button(btnFrame, text="List", command=lambda: frame_fileinfo.insert(tk.END, str(getFiles())),
        ...
        self.text_status = Label(self.root, bg="white", width=85, height=25)
